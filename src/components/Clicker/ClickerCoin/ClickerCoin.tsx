...
import Canvas from "@/components/Clicker/ClickerCoin/Canvas"
import dot from '@/components/Clicker/ClickerCoin/dot'
...
class ClickerCoin extends Component<CoinProps, CoinState> {
