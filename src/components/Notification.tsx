...
import {
  ...
  DoneIcon as SuccessIcon,
  InfoIcon,
  StarIcon,
} from '@/assets/icons';
import { styled, keyframes, globalCss } from '@/core/stitches.config';
...
export const Notification: React.FC<NotificationProps> = ({ message, type, icon }) => {
  return (
...
const createNotification = (message: string, type: NotificationProps['type'], icon: React.FC) => {
  return () =>
    toast(<Notification message={message} type={type} icon={icon} />, {
      position: 'top-center',
...
export const AchievementNotification = (message: string) =>
  createNotification(message, 'achievement', StarIcon);
export const InformationNotification = (message: string) =>
  createNotification(message, 'info', InfoIcon);
export const ErrorNotification = (message: string) =>
  createNotification(message, 'error', ErrorIcon);
export const SuccessNotification = (message: string) =>
  createNotification(message, 'success', SuccessIcon);
